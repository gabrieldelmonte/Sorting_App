...
echo "=== Python Sorting Algorithms - Performance Benchmark ==="
...
python3 algorithms.py --file perf_small.txt --algorithms bubble_sort,selection_sort,insertion_sort,quick_sort,merge_sort,heap_sort,counting_sort,radix_sort,bucket_sort --runs 5

echo ""
echo "=== Medium Dataset (1000 elements) - 10 runs each ==="
python3 algorithms.py --file perf_medium.txt --algorithms quick_sort,merge_sort,heap_sort,counting_sort,radix_sort,bucket_sort --runs 10

echo ""
echo "=== Large Dataset (10000 elements) - 3 runs each ==="
python3 algorithms.py --file perf_large.txt --algorithms quick_sort,merge_sort,heap_sort --runs 3

echo ""
echo "=== Best Case Scenario (Already Sorted) - 5 runs each ==="
python3 algorithms.py --file perf_best.txt --algorithms bubble_sort,insertion_sort,quick_sort,merge_sort --runs 5

echo ""
echo "=== Worst Case Scenario (Reverse Sorted) - 5 runs each ==="
python3 algorithms.py --file perf_worst.txt --algorithms bubble_sort,selection_sort,insertion_sort,quick_sort,merge_sort --runs 5
...
echo ""
echo "Summary of your algorithms.py:"
...
echo ""
echo "Your Python sorting algorithms implementation is CORRECT and COMPLETE!"
echo "Results saved to: ../../resources/results/results_python.json"
